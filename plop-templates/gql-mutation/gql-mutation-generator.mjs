    ...
    config: {
        ...
        actions: function (data) {
            const actions = [
                {
                    type: 'add',
                    path: `src/{{path}}/${data.addMock ? '{{kebabCase name}}/' : ''}{{kebabCase name}}.js`,
            ...
            if (data.addMock) {
                ...
                actions.push({
                    type: 'add',
                    path: 'src/{{path}}/{{kebabCase name}}/mock/{{kebabCase name}}.integration.spec.js',
                    templateFile: 'plop-templates/gql-mutation/gql-mutation-mock.spec.hbs',
                });
            }
