...
const { exposeFPopoverMethods, hideOnDocumentMousedown } = useFPopover(WALLET_BUTTON_POPOVER_ID, popover);
...
<template>
    ...
    >
        <slot>
            <WalletsInfoPage :one-account-mode="appConfig.oneAccountMode" />
        </slot>
    </FPopover>
</template>
