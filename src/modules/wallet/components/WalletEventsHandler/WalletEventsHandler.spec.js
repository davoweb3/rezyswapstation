...
import { TEST_ACCOUNT, TEST_ACCOUNT2, TestWeb3Wallet } from '@/plugins/web3-wallets/test-helpers.js';
import { Accounts, useAccounts } from '@/modules/account/index.js';
...
describe('WalletEventsHandler', () => {
    ...
    it.skip('should show "bad account" warning message', async () => {
        wrapper = createWrapper();
        ...
        expect(wrapper.vm.$refs.badAccountWarningWindow.isWindowVisible()).toBe(true);
    });
