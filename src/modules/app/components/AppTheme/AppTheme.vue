...
watch(
    ...
    (value) => {
        setDarkTheme(value && prefersColorScheme ? prefersColorScheme.matches : appStore.theme === 'theme-dark');
    }
);
...
onMounted(() => {
    ...
    setDarkTheme(
        appStore.autoDarkTheme && prefersColorScheme ? prefersColorScheme.matches : appStore.theme === 'theme-dark'
    );
});
</script>
