 ...
 */
export function adjustToken(token, symbolsToAdjust = SYMBOLS_TO_ADJUST, logosToAdjust = LOGOS_TO_ADJUST) {
 ...
 * @param {Object} [logosToAdjust]
 */
export function adjustTokens(tokens, symbolsToAdjust = SYMBOLS_TO_ADJUST, logosToAdjust = LOGOS_TO_ADJUST) {
    tokens.forEach((token) => adjustToken(token, symbolsToAdjust, logosToAdjust));
}
